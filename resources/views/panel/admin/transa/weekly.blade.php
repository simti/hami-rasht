      ...
      <div class="card bg-primary p-20">
        <div class="media widget-ten">
          ...
          <div class="media-body media-text-right">
            <h2 class="color-white">{{currency_to_per(\App\Transaction::ThisWeek()->Paid()->sum('amount'))}} ریال</h2>
    ...
    <div class="col-md-3">
      <div class="card bg-pink p-20">
        <div class="media widget-ten">
          ...
          <div class="media-body media-text-right">
            <h2 class="color-white">{{eng_to_per(\App\Transaction::ThisWeek()->Paid()->count())}} عدد</h2>
    ...
    <div class="col-md-3">
      <div class="card bg-success p-20">
        <div class="media widget-ten">
          ...
          <div class="media-body media-text-right">
            <h2 class="color-white">{{currency_to_per(\App\Transaction::ThisWeek()->Paid()->sum('foody_amount'))}} ریال</h2>
    ...
    <div class="col-md-3">
      <div class="card bg-danger p-20">
        <div class="media widget-ten">
          ...
          <div class="media-body media-text-right">
            <h2 class="color-white">{{currency_to_per(\App\Transaction::ThisWeek()->Paid()->AboutOrder()->sum('dst_amount'))}} ریال</h2>
                  ...
                  <script>
                    ...
                    function fetch_orders_transactions(){
                        var settings = {
                            "async": true,
                            "crossDomain": true,
                            "url": "{{route('admin.transactions.weekly.orders.fetch')}}?page=" + orders_transactions_page + "&term=" + orders_transactions_term,
                            "method": "GET",
                            "headers": {
                    ...
                    function pagination_orders_transactions(){
                        var settings = {
                            "async": true,
                            "crossDomain": true,
                            "url": "{{route('admin.transactions.weekly.orders.count')}}?term=" + orders_transactions_term,
                            "method": "GET",
                            "headers": {
                                "accept": "application/json",
                                "content-type": "application/json"
                  ...
                  <script>
                      ...
                      function fetch_free_transactions(){
                          var settings = {
                              "async": true,
                              "crossDomain": true,
                              "url": "{{route('admin.transactions.weekly.free.fetch')}}?page=" + free_transactions_page + "&term=" + free_transactions_term,
                              "method": "GET",
                              "headers": {
                                  "accept": "application/json",
                                  "content-type": "application/json"
                      ...
                      function pagination_free_transactions(){
                          var settings = {
                              "async": true,
                              "crossDomain": true,
                              "url": "{{route('admin.transactions.weekly.free.count')}}?term=" + free_transactions_term,
                              "method": "GET",
                              "headers": {
                                  "accept": "application/json",
                                  "content-type": "application/json"
                    ...
                    <script>
                        ...
                        function fetch_charges_transactions(){
                            var settings = {
                                "async": true,
                                "crossDomain": true,
                                "url": "{{route('admin.transactions.weekly.charges.fetch')}}?page=" + charges_transactions_page + "&term=" + charges_transactions_term,
                                "method": "GET",
                                "headers": {
                                    "accept": "application/json",
                                    "content-type": "application/json"
                        ...
                        function pagination_charges_transactions(){
                            var settings = {
                                "async": true,
                                "crossDomain": true,
                                "url": "{{route('admin.transactions.weekly.charges.count')}}?term=" + charges_transactions_term,
                                "method": "GET",
                                "headers": {
                                    "accept": "application/json",
                                    "content-type": "application/json"
                    ...
                    <script>
                        ...
                        function fetch_withdraws_transactions(){
                            var settings = {
                                "async": true,
                                "crossDomain": true,
                                "url": "{{route('admin.transactions.weekly.withdraws.fetch')}}?page=" + withdraws_transactions_page + "&term=" + withdraws_transactions_term,
                                "method": "GET",
                                "headers": {
                                    "accept": "application/json",
                                    "content-type": "application/json"
                        ...
                        function pagination_withdraws_transactions(){
                            var settings = {
                                "async": true,
                                "crossDomain": true,
                                "url": "{{route('admin.transactions.weekly.withdraws.count')}}?term=" + withdraws_transactions_term,
                                "method": "GET",
                                "headers": {
                                    "accept": "application/json",
                                    "content-type": "application/json"
                            ...
                            $.ajax(settings).done(function (response) {
                                ...
                                for(let i=Math.max(0, transactions_page-1); i<=Math.min(transactions_page+1, last_page); i++){
                                  if(i==withdraws_transactions_page){
                                    ...
                                    content += ' <button onclick="load_withdraws_transactions('+i+')" type="button" class="btn btn-primarybtn-primary-transparent pagination-btn">'+ (i+1) +'</button> ';
                                  }
                                }
                                if(transactions_page < last_page-1)
                                    content += '...';
                        ...
                        function accept_withdraw(transaction_id){
                          var settings = {
                              "async": true,
                              "crossDomain": true,
                              "url": "{{route('admin.transactions.weekly.withdraws.accept')}}?transaction_id=" + transaction_id,
                              "method": "GET",
                              "headers": {
                                  "accept": "application/json",
                                  "content-type": "application/json"
                        ...
                        function refuse_withdraw(transaction_id){
                          var settings = {
                              "async": true,
                              "crossDomain": true,
                              "url": "{{route('admin.transactions.weekly.withdraws.refuse')}}?transaction_id=" + transaction_id,
                              "method": "GET",
                              "headers": {
                                  "accept": "application/json",
                                  "content-type": "application/json"
