      ...
      <div class="card bg-primary p-20">
        <div class="media widget-ten">
          ...
          <div class="media-body media-text-right">
            <h2 class="color-white">{{currency_to_per(\App\Transaction::ThisMonth()->Paid()->sum('amount'))}} ریال</h2>
    ...
    <div class="col-md-3">
      <div class="card bg-pink p-20">
        <div class="media widget-ten">
          ...
          <div class="media-body media-text-right">
            <h2 class="color-white">{{eng_to_per(\App\Transaction::ThisMonth()->Paid()->count())}} عدد</h2>
    ...
    <div class="col-md-3">
      <div class="card bg-success p-20">
        <div class="media widget-ten">
          ...
          <div class="media-money media-text-right">
            <h2 class="color-white">{{currency_to_per(\App\Transaction::ThisMonth()->Paid()->sum('foody_amount'))}} ریال</h2>
    ...
    <div class="col-md-3">
      <div class="card bg-danger p-20">
        <div class="media widget-ten">
          ...
          <div class="media-body media-text-right">
            <h2 class="color-white">{{currency_to_per(\App\Transaction::ThisMonth()->Paid()->AboutOrder()->sum('dst_amount'))}} ریال</h2>
                  ...
                  <script>
                      ...
                      function fetch_orders_transactions(){
                          var settings = {
                              "async": true,
                              "crossDomain": true,
                              "url": "{{route('admin.transactions.monthly.orders.fetch')}}?page=" + orders_transactions_page + "&term=" + orders_transactions_term,
                              "method": "GET",
                              "headers": {
                      ...
                      function pagination_orders_transactions(){
                          var settings = {
                              "async": true,
                              "crossDomain": true,
                              "url": "{{route('admin.transactions.monthly.orders.count')}}?term=" + orders_transactions_term,
                              "method": "GET",
                              "headers": {
                                  "accept": "application/json",
                                  "content-type": "application/json"
                  ...
                  <script>
                      ...
                      function fetch_free_transactions(){
                          var settings = {
                              "async": true,
                              "crossDomain": true,
                              "url": "{{route('admin.transactions.monthly.free.fetch')}}?page=" + free_transactions_page + "&term=" + free_transactions_term,
                              "method": "GET",
                              "headers": {
                                  "accept": "application/json",
                                  "content-type": "application/json"
                      ...
                      function pagination_free_transactions(){
                          var settings = {
                              "async": true,
                              "crossDomain": true,
                              "url": "{{route('admin.transactions.monthly.free.count')}}?term=" + free_transactions_term,
                              "method": "GET",
                              "headers": {
                                  "accept": "application/json",
                                  "content-type": "application/json"
                    ...
                    <script>
                        ...
                        function fetch_charges_transactions(){
                            var settings = {
                                "async": true,
                                "crossDomain": true,
                                "url": "{{route('admin.transactions.monthly.charges.fetch')}}?page=" + charges_transactions_page + "&term=" + charges_transactions_term,
                                "method": "GET",
                                "headers": {
                                    "accept": "application/json",
                                    "content-type": "application/json"
                        ...
                        function pagination_charges_transactions(){
                            var settings = {
                                "async": true,
                                "crossDomain": true,
                                "url": "{{route('admin.transactions.monthly.charges.count')}}?term=" + charges_transactions_term,
                                "method": "GET",
                                "headers": {
                                    "accept": "application/json",
                                    "content-type": "application/json"
                    ...
                    <script>
                        ...
                        function fetch_withdraws_transactions(){
                            var settings = {
                                "async": true,
                                "crossDomain": true,
                                "url": "{{route('admin.transactions.monthly.withdraws.fetch')}}?page=" + withdraws_transactions_page + "&term=" + withdraws_transactions_term,
                                "method": "GET",
                                "headers": {
                                    "accept": "application/json",
                                    "content-type": "application/json"
                        ...
                        function pagination_withdraws_transactions(){
                            var settings = {
                                "async": true,
                                "crossDomain": true,
                                "url": "{{route('admin.transactions.monthly.withdraws.count')}}?term=" + withdraws_transactions_term,
                                "method": "GET",
                                "headers": {
                                    "accept": "application/json",
                                    "content-type": "application/json"
                        ...
                        function accept_withdraw(transaction_id){
                          var settings = {
                              "async": true,
                              "crossDomain": true,
                              "url": "{{route('admin.transactions.monthly.withdraws.accept')}}?transaction_id=" + transaction_id,
                              "method": "GET",
                              "headers": {
                                  "accept": "application/json",
                                  "content-type": "application/json"
                        ...
                        function refuse_withdraw(transaction_id){
                          var settings = {
                              "async": true,
                              "crossDomain": true,
                              "url": "{{route('admin.transactions.monthly.withdraws.refuse')}}?transaction_id=" + transaction_id,
                              "method": "GET",
                              "headers": {
                                  "accept": "application/json",
                                  "content-type": "application/json"
